...
class Showtime(models.Model):
    STATUS = (("pending", "PENDING"), ("upcoming", "UPCOMING"), ("complete", "COMPLETE"))
    ...
    def remaining_seats(self):
        ...
        booked_seats = Ticket.objects.filter(
            booking__showtime=self, booking__status="confirmed"
        ).count()
        return self.screen_id.total_seats - booked_seats

    class Meta:
        unique_together = ["movie_id", "screen_id", "start_time"]
